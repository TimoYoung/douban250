...
- **排名历史图** — 时间轴按实际日期比例展示，直观反映版本间的时间间隔
- **智能搜索** — 搜索当前版本内电影（气泡视图高亮命中），并跨所有版本查找，显示最近版本和排名，支持一键跳转
- **版本选择器** — 按年份分组展示，版本多时也能快速定位
...
| GET | `/api/movies/search?q=xxx` | 全局搜索（跨版本，返回最近版本及排名） |
